...
class ConfirmTransactionTest extends TestCase
{
    ...
    public function test_that_a_call_to_the_server_will_be_successful_if_all_is_right()
    {
         ...
         */
        $mock = $this->getMockBuilder(ConfirmTransaction::class)
        ...
        $this->assertContains(
            "https://app.slydepay.com.gh/api/merchant/transaction/confirm",
